...
export default class Decoder extends Transform {
  ...
  _transform(chunk, enc, cb) {
    if (this.initial) {
      ...
      const { enc, ambiguous=false, supported=true } = findEnc(chunk);
  ...
  async _transformSync(chunk) {
    ...
    // definite absence of one). This is why we can’t model the decoder, grammar
    // and assembler as streams -- the xml encoding detection algorithm demands
    // that these three steps be coupled synchronously.

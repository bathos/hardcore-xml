...
export default class Parser extends Writable {
	constructor({ strict, ignoreWhite=true, html, normalize, target }={}) {
		...
		if (this.target === 'DocumentFragment' && this.html)
			throw new HTE(msg.invalidParseTarget, this.target);
		...
		this.on('finish', () => {
			...
			if (this.html && !this[$buffer] && !this[$doc])
				this[$buffer] = '<html><head></head><body></body></html>';
